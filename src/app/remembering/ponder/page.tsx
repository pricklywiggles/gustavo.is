...
export default function PonderProject() {
  ...
  return (
    <div className="dark:text-gray-300 text-gray-800">
      <div className="relative mt-10 text-bg-lt-bg dark:bg-dk-bg overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="relative transition-all duration-500 z-10 pb-8 md:py-10 bg-lt-bg dark:bg-dk-bg md:max-w-lg lg:max-w-2xl ">
            <svg
              className="hidden transition-all duration-500 md:block absolute right-0 inset-y-0 h-full w-48 dark:text-dk-bg text-lt-bg fill-current transform translate-x-1/2"
              viewBox="0 0 100 100"
...
export const metadata = buildStaticMetadata('ponder');
