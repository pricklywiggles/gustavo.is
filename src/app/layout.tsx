...
import './globals.css';
import { wotfard, wavesSignal } from '@/fonts/fonts';
...
export default function RootLayout({
  ...
  return (
    <html lang='en' suppressHydrationWarning>
      ...
      <body
        className={`${wotfard.variable} ${wavesSignal.variable} font-sans text-gray-800 bg-lt-bg dark:text-gray-300 dark:bg-dk-bg`}
      >
        <SiteHeader />
        {children}
      </body>
