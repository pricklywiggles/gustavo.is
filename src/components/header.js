...
export default function Header() {
  ...
  return (
    <header>
      <div className="relative sm:fixed w-screen">
        ...
        <div className="relative mx-auto sm:flex sm:justify-between sm:items-center max-w-screen-lg p-4">
          <div className="flex items-center justify-between">
            ...
            <div className="fixed top-0 right-0 z-10 sm:hidden m-6">
              <button
                className="block bg-bglight-8 dark:bg-bgdark-8 rounded-full dark:focus:text-accentdark dark:hover:text-accentdark focus:outline-none"
          ...
          <div
            ...
            } fixed sm:static flex flex-col sm:flex-row sm:items-center w-screen sm:w-auto inset-0 text-2xl sm:text-lg bg-blur-20 sm:bg-blur-0 p-6 sm:p-0 transition-all duration-500 boing`}
          >
            <NavLink href="/" passHref>
              <a className="box marker font-semibold hover:cursor-pointer hover:text-accentdark dark:focus:text-accentdark sm:mt-0 sm:pl-4">
                Portfolio
              </a>
            </NavLink>
            <NavLink href="/blog" passHref>
              <a className="box font-semibold hover:cursor-pointer hover:text-accentdark dark:focus:text-accentdark sm:mt-0 sm:pl-4">
                Blog
              </a>
            </NavLink>
            ...
            <button
              ...
              type="button"
            >
              <div className="invert-80 dark:invert-0">
                {isDark ? "☀️" : "🌓"}
              </div>
              {/* <svg
      ...
      <div className="hidden sm:block p-20"></div>
    </header>
  );
}
