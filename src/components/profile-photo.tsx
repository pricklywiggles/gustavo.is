...
export function ProfilePhoto({
  ...
  return (
    <div>
      <div className="relative overflow-hidden transition-all duration-500 bg-lt-bg dark:bg-dk-bg w-full h-full">
        <div
        ...
        <svg
          className="relative transition-all duration-500 fill-current text-lt-bg dark:text-dk-bg"
