...
export const ProjectCard: FComp<ProjectCardProps> = ({
  title,
  href,
  logo,
  stack,
        ...
        <div className="flex p-2 flex-col justify-around border-l sm:border-l-0 sm:border-t border-dk-bg-400 px-2 text-center w-48 h-48">
          ...
          <div className="flex justify-around">
            {stack.map((technology) => {
              const logo = logos[technology as keyof typeof logos];
              if (logo)
                return React.createElement(logo.component, {
                  key: technology,
                  className: 'h-6 w-6'
                });
            })}
